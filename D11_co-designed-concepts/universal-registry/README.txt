...
More about the session:
 ...
 - Workshop [application](mozfest-application.txt) and [overview](mozfest.txt)
 - [Preparation blog post](mozfest-preparation_blog-post.txt)
 - [Session notes](mozfest-session-notes.txt).
